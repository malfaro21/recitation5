...
public class Circle
{
    ...
    {
        double dis = location.distanceTo(p);
        return radius > dis;
    }
    ...
    {
        double intersect = location.distanceTo(aCircle.getLocation());
        double totalRadius = aCircle.radius + this.radius;
        return intersect < totalRadius;
    }
